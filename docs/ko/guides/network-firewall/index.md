...
* Strict 규칙 순서를 선택하면, 모든 규칙의 끝에서 실행되어 이전 규칙과 일치하지 않는 트래픽에 적용되는 "Default" 작업도 선택할 수 있습니다.
...
# $HOME_NET 클라이언트의 TCP 3-way handshake를 로그 없이 허용
...
# 커스텀 차단 규칙
# "Drop All" 또는 "Drop Established" 기본 작업을 대체합니다
