...
* [Security Hub란 무엇인가](#security-hub란-무엇인가)
* [Security Hub 활성화의 이점은 무엇인가](#security-hub-활성화의-이점은-무엇인가)
* [시작하기](#시작하기)
    * [배포 고려사항](#배포-고려사항)
    * [리전 고려사항](#리전-고려사항)
* [구현](#구현)
    ...
    * [보안 표준 활성화](#보안-표준-활성화)
* [운영화](#운영화)
    * [중요 및 높음 수준 탐지 결과에 대한 조치](#중요-및-높음-수준-탐지-결과에-대한-조치)
    * [사용자 정의 인사이트 생성](#사용자-정의-인사이트-생성)
    * [사용 가능한 해결 지침 활용](#사용-가능한-해결-지침-활용)
    * [보안 표준 제어 미세 조정](#보안-표준-제어-미세-조정)
    * [자동화 규칙](#자동화-규칙)
    * [자동화된 보안 대응](#자동화된-보안-대응)
    * [타사 통합](#타사-통합)
* [비용 고려사항](#비용-고려사항)
