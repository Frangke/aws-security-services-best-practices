...
* [Amazon Inspector란 무엇인가](#amazon-inspector란-무엇인가)
* [Amazon Inspector 활성화의 이점은 무엇인가](#amazon-inspector-활성화의-이점은-무엇인가)
* [시작하기](#시작하기)
...
* [적용 범위](#적용-범위)
    * [Amazon EC2 스캔](#amazon-ec2-스캔)
    * [Windows 스캔](#windows-스캔)
    * [ECR 스캔](#ecr-스캔)
    * [Lambda 스캔](#lambda-스캔)
    * [CI/CD](#cicd-스캔)
    * [CIS 스캔](#cis-스캔)
* [운영화](#운영화)
    * [Inspector 탐지 결과 조치](#inspector-탐지-결과-조치)
    * [소프트웨어 자재 명세서(SBOM) 구성](#소프트웨어-자재-명세서sbom-구성)
    * [억제 규칙](#억제-규칙)
    * [취약점 데이터베이스 검색](#취약점-데이터베이스-검색)
* [비용 고려 사항](#비용-고려-사항)
* [리소스](#리소스)
