...
* [GuardDuty 배포](#deploying-guardduty)
    * [단일 계정 배포](#single-account-deployment)
    * [다중 계정 배포](#multi-account-deployment)
        * [위임된 관리자 활성화](#enablement-of-a-delegated-administrator)
        * [조직에 대한 자동 활성화 기본 설정 구성](#configuring-auto-enable-preferences-for-organization)
        * [조직에 멤버로 계정 추가](#add-accounts-as-members-to-your-organization)
    * [GuardDuty 보호 플랜](#guardduty-protection-plans)
        * [S3 멀웨어 보호 활성화](#S3-Malware-Protection)
        * [런타임 모니터링](#runtime-monitoring-deployment-for-ec2)
            * [EC2용 런타임 모니터링 활성화](#runtime-monitoring-deployment-for-ec2)
            * [ECS용 런타임 모니터링 활성화](#runtime-monitoring-deployment-for-ecs)
            * [EKS용 런타임 모니터링 활성화](#runtime-monitoring-deployment-for-eks) 
* [GuardDuty 탐지 결과 운영화](#operationalize-guardduty-findings)
    * [탐지 결과 필터링](#filtering-findings)
    * [잠재적 노이즈 감소](#reducing-potential-noise)
    * [높은 우선순위 탐지 결과에 대한 자동 알림](#automated-notification-for-high-priority-findings)
    * [일반적인 탐지 결과 유형에 대한 자동 해결](#automated-remediation-for-common-finding-types)
* [비용 최적화](#cost-optimization)
    * [CloudTrail 및/또는 S3 데이터 이벤트 사용량이 높은 경우](#cloudtrail-andor-s3-data-event-utilization-is-high)
